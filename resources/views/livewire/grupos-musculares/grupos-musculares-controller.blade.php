<div class="row sales layout-top-spacing">
                    ...
                    <table class="table table-bordered table-striped mt-1">
                        <thead class="text-white" style="background: #3B3F5C">
                            <tr>
                                ...
                                <th class="table-th text-white text-center">imgen</th>
                        ...
                        <tbody>
                            @foreach($grupos as $video)
                            <tr>
                                <td class="text-center">
                                    <h6>{{$video->nombre}}</h6>
                                </td>
                                <td class="text-center">
                                    <img src="data:image/jpeg;base64,{{ $video->imagen }}" alt="Miniatura"
    ...
    @include('livewire.grupos-musculares.form')
</div>
